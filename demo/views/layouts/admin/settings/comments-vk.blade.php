<fieldset>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="checkbox">
                <label>
                    <input type="checkbox" id="commentsVkEnabled" name="comments_vk_enabled" {{ Conf::get('social.comments.vk.enabled', false) ? 'checked' : '' }}> Активно
                </label>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="vkAppId">App ID <small><a href="https://vk.com/dev/Comments">Получить App ID</a></small></label>
                <input type="text" name="vk_app_id" id="vkAppId" value="{{ Conf::get('social.vk.app_id', '') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label for="commentsVkWidth">Ширина</label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="commentsVkLimit">Ограничения по комментариям</label>
