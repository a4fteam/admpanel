...
use App\Database\DatabaseUpdater;
use App\Database\Schema\Column;
use App\Database\Schema\Identifier;
...
class VoyagerDatabaseController extends Controller
{
    public function index()
    {
        ...
        return view('admpanel::tools.database.index')->with(compact('dataTypes', 'tables'));
    }
    ...
    public function create()
    {
        ...
        return view('admpanel::tools.database.edit-add', compact('db'));
    }
    ...
    public function addEditBread($table)
    {
        ...
        return view('admpanel::tools.database.edit-add-bread', compact('dataType', 'fieldOptions', 'isModelTranslatable'));
    }
