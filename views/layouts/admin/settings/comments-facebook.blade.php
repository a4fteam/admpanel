<fieldset>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="checkbox">
                <label>
                    <input type="checkbox" id="commentsFacebookEnabled" name="comments_facebook_enabled" {{ Conf::get('social.comments.facebook.enabled', false) ? 'checked' : '' }}> Активно
                </label>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                <label for="commentsFacebookWidth">Ширина</label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="commentsFacebookLimit">Ограничения по комментариям</label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="commentsFacebookColorScheme">Цветовая схема</label>
                <select name="comments_facebook_color_scheme" id="commentsFacebookColorScheme" class="form-control">
                    <option value="light" {{ (Conf::get('social.comments.facebook.color_scheme') == 'light') ? 'selected' : '' }}>Светлая</option>
                    <option value="dark" {{ (Conf::get('social.comments.facebook.color_scheme') == 'dark') ? 'selected' : '' }}>Тёмная</option>
                </select>
            </div>
        </div>
    </div>
